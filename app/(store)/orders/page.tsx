...
async function Orders() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
      <div className="bg-white px-4 sm:py-8 rounded-xl shadow-lg w-full max-w-4xl">
        ...
        {orders.length === 0 ? (
          ...
          <div className="scroll-py-6 sm:space-y-8">
            {orders.map(order => (
              <div key={order.orderNumber}
                   className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
                <div className="p-4 sm:py-6 border-b border-gray-200">
                ...
                <div className="px-4 py-3 sm:py-4 sm:py-4">
